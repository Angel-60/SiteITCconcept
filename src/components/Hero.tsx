    ...
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        <div className="animate-fade-in">
          <h1 className="text-7xl md:text-8xl lg:text-9xl font-serif font-bold text-[#D4AF37] mb-6 tracking-wide">
            ITC
          </h1>

          <div className="w-32 h-0.5 bg-[#D4AF37] mx-auto mb-8"></div>

          <p className="text-xl md:text-2xl lg:text-3xl text-white/90 font-light mb-12 leading-relaxed max-w-3xl mx-auto">
            Professional Solutions in Marketing & Social Media Management
          </p>

          <p className="text-base md:text-lg text-white/70 font-light mb-12 max-w-2xl mx-auto leading-relaxed">
          ...
          <button
            ...
            className="group relative inline-flex items-center px-8 py-4 text-base font-medium text-black bg-[#D4AF37] hover:bg-[#E5C158] transition-all duration-300 overflow-hidden"
          >
